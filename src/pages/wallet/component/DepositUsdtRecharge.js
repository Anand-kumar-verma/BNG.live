...
function DepositeUsdtrecharge() {
    ...
    const selectedUPIDetails = Array.isArray(res) ? res.find(
        (item) => item?.id === fk.values.deposit_type
    ) : null;
            ...
            <>
                ...
                >
                    ...
                    <Button
                        ...
                        onClick={() =>
                            fk.setFieldValue("req_amount", 50)}
                    >
                        {" "}
                        $ 50
                    </Button>
        ...
        <Layout header={false}>
            ...
            >
                ...
                <Box className="fccsb w95" mt={2}>
                    <Box sx={{ width: '48%', background: '#FFFFFF', borderRadius: "5px" }} className="fccc" onClick={() => navigate('/wallet/Recharge')}>
                    ...
                    <Box sx={{ width: '48%', background: '#FFFFFF', borderRadius: "5px" }} className="fccc" >

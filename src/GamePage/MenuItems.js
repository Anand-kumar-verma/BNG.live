...
import AvatarCmp from "./DialogComponent/AvatarCmp";
      ...
      >
        ...
        >
          <p className="flex items-center ">
            <Avatar
              src={
                localStorage.getItem("Aviator_avtar") ||
                "https://mui.com/static/images/avatar/3.jpg"
              }
            />
            <span className="!font-bold">
              bngproc_{statusyesterday?.username?.substring(0, 5)}
            </span>
          </p>
          <p
            className="flex items-center gap-1 bg-black rounded-full px-3 py-1 cursor-pointer"
            onClick={() => {
              setOpenCustomDialogBox(true);
              setTypeOfDialogBox("Change Avtar");
            }}
          >
        ...
        >
          ...
          <p>
            <Switch
              ...
              onClick={() => dispatch(isEnableSoundFun())}
            />
          </p>
        </MenuItem>
        ...
        >
          ...
          <p>
            <Switch
              ...
              size="small"
              onClick={() => dispatch(isEnableMusicFun())}
            />
          </p>
        </MenuItem>
        <Divider className="!bg-gray-500 !p-0" />
      ...
      {openCustomDialogBox && (
        <CustomDialogBox
          ...
          component={
            ...
            (typeOfDialogBox === "Change Avtar" && <AvatarCmp />) ||
            (typeOfDialogBox === "Game Limits" && <GameLimits />) ||
            (typeOfDialogBox === "My Bet History" && <MybetHistory />) ||
            (typeOfDialogBox === "Change Background" && (
              <Changebackground
                setOpenCustomDialogBox={setOpenCustomDialogBox}
                handleClose={handleClose}
              />
            )) ||
            (typeOfDialogBox === "Change Music" && (
          ...
          title={
            ...
            (typeOfDialogBox === "Change Avtar" && "CHOOSE AVTAR") ||
